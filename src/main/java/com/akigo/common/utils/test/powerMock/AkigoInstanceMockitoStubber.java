 ...
 * @version 1.0.0
 */
public class AkigoInstanceMockitoStubber<T> {
    private T mockedTarget;
    protected AkigoInstanceMockitoStubber(T mockedTarget) {
...
//    }
     ...
     *             If something unexpected goes wrong.
     */
    public <T> OngoingStubbing<T> when(String methodName, Object... arguments) {
        try {
            return PowerMockito.when(this.mockedTarget, methodName, arguments);
        } catch(Exception e) {
...
//    }
     ...
     *             If something unexpected goes wrong.
     */
//    public <T> OngoingStubbing<T> when(Class<?> clazz, String methodToExpect, Object... arguments)
//            throws Exception {
//        return PowerMockito.when(clazz, methodToExpect, arguments);
//    }
